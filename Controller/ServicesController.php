 ...
 */
class ServicesController extends RailCompetencyAppController {
 ...
 */
	public function index() {
		...
		$this->Paginator->settings['conditions'] = $this->Service->parseCriteria($this->Prg->parsedParams());
 ...
 */
	...
	public function object($id = null) {
		...
		$options = array('conditions' => array('Service.' . $this->Service->primaryKey => $id));
		return $this->Service->find('first', $options);
	}
 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			if (isset($this->request->data['Service']['start_date'])) {
				$this->request->data['Service']['start_date'] = $this->split_date($this->request->data['Service']['start_date']);
				$this->request->data['Service']['end_date'] = $this->split_date($this->request->data['Service']['end_date']);
			}
 ...
 */
	public function admin_add() {
		if ($this->request->is('post')) {
			if (isset($this->request->data['Service']['start_date'])) {
				$this->request->data['Service']['start_date'] = $this->admin_split_date($this->request->data['Service']['start_date']);
				$this->request->data['Service']['end_date'] = $this->admin_split_date($this->request->data['Service']['end_date']);
			}
