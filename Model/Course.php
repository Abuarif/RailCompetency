 ...
 */
class Course extends RailCompetencyAppModel {

	public $uploadsDir = 'attachments'; 
	public $fieldName = 'files'; 
	public $displayField = 'name'; 

	// public $displayField = 'CONCAT(code, " - ", name)';

	// public $virtualFields = array(
	//     'course_name' => 'CONCAT(Course.code, " - ", Course.name)'
	// );
 ...
 */
	public $validate = array(
		'code' => array(
			'notEmpty' => array(
				'rule' => array('notEmpty'),
				'message' => 'Please key in the course code',
				//'allowEmpty' => false,
				//'required' => false,
		...
		'name' => array(
			'notEmpty' => array(
				'rule' => array('notEmpty'),
				'message' => 'Please key in the course name.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				'on' => 'create', // Limit validation to 'create' or 'update' operations
 ...
 */
	public $hasMany = array(
		...
		'CourseRequisite' => array(
			'className' => 'CourseRequisite',
			'foreignKey' => 'course_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
		...
		'OrganizationCourse' => array(
			'className' => 'OrganizationCourse',
			'foreignKey' => 'course_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
