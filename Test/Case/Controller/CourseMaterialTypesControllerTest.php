<?php
App::uses('CourseMaterialTypesController', 'RailCompetency.Controller');

/**
 * CourseMaterialTypesController Test Case
 *
 */
class CourseMaterialTypesControllerTest extends ControllerTestCase {
