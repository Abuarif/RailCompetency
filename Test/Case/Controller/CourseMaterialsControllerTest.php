<?php
App::uses('CourseMaterialsController', 'RailCompetency.Controller');

/**
 * CourseMaterialsController Test Case
 *
 */
class CourseMaterialsControllerTest extends ControllerTestCase {
