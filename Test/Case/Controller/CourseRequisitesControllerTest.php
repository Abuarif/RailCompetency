<?php
App::uses('CourseRequisitesController', 'RailCompetency.Controller');

/**
 * CourseRequisitesController Test Case
 *
 */
class CourseRequisitesControllerTest extends ControllerTestCase {
