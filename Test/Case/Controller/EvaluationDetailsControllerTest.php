<?php
App::uses('EvaluationDetailsController', 'RailCompetency.Controller');

/**
 * EvaluationDetailsController Test Case
 *
 */
class EvaluationDetailsControllerTest extends ControllerTestCase {
