<?php
App::uses('EvaluationTypesController', 'RailCompetency.Controller');

/**
 * EvaluationTypesController Test Case
 *
 */
class EvaluationTypesControllerTest extends ControllerTestCase {
