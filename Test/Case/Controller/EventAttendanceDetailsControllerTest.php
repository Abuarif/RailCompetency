<?php
App::uses('EventAttendanceDetailsController', 'RailCompetency.Controller');

/**
 * EventAttendanceDetailsController Test Case
 *
 */
class EventAttendanceDetailsControllerTest extends ControllerTestCase {
