<?php
App::uses('ProgramCoursesController', 'RailCompetency.Controller');

/**
 * ProgramCoursesController Test Case
 *
 */
class ProgramCoursesControllerTest extends ControllerTestCase {
