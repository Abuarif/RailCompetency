<?php
App::uses('StaffAssignmentsController', 'RailCompetency.Controller');

/**
 * StaffAssignmentsController Test Case
 *
 */
class StaffAssignmentsControllerTest extends ControllerTestCase {
