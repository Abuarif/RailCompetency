<?php
App::uses('StaffTrainingsController', 'RailCompetency.Controller');

/**
 * StaffTrainingsController Test Case
 *
 */
class StaffTrainingsControllerTest extends ControllerTestCase {
