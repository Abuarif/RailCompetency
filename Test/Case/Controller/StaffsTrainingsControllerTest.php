<?php
App::uses('StaffsTrainingsController', 'RailCompetency.Controller');

/**
 * StaffsTrainingsController Test Case
 *
 */
class StaffsTrainingsControllerTest extends ControllerTestCase {
