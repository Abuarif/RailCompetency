          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Course Material Permission'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Course Material Permission'); ?>'s Details</h3>
          </div>
		...
		<p>
			<?php echo h($courseMaterialPermission['CourseMaterialPermission']['id']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Name'); ?></small>
		<p>
			<?php echo h($courseMaterialPermission['CourseMaterialPermission']['name']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Active'); ?></small>
		<p>
			<?php echo h($courseMaterialPermission['CourseMaterialPermission']['active']); ?>
			&nbsp;
		</p>
                        </section>
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Course Material Permission'), array('action' => 'edit', $courseMaterialPermission['CourseMaterialPermission']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Course Material Permission'), array('action' => 'delete', $courseMaterialPermission['CourseMaterialPermission']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $courseMaterialPermission['CourseMaterialPermission']['id'])); ?>  <?php echo $this->Html->link(__('List Course Material Permissions'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Course Material Permission'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
                          ...
                          <div class="list-group bg-white">
                          <?php echo $this->Html->link(__('List Course Materials'), array('controller' => 'course_materials', 'action' => 'index'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp; <?php echo $this->Html->link(__('New Course Material'), array('controller' => 'course_materials', 'action' => 'add'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp;                           </div>
                        </section>
                      </div>
                      <!-- end portlet -->
                    </section>
                      ...
                      <div class="tab-content">
                        ...
                        <!-- start hasOne -->
                          ...
                          <!-- start hasMany -->
                            ...
                            <?php if (!empty($courseMaterialPermission['CourseMaterial'])): ?>
                            <section class="panel panel-default padder">
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                  ...
                                  <tbody>
                                  	<?php foreach ($courseMaterialPermission['CourseMaterial'] as $courseMaterial): ?>
		<tr>
			<td class="actions">
