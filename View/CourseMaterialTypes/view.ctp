          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Course Material Type'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Course Material Type'); ?>'s Details</h3>
          </div>
                      ...
                      <div class="tab-content">
                        ...
                        <!-- start hasOne -->
                          ...
                          <!-- start hasMany -->
                            ...
                            <?php if (!empty($courseMaterialType['CourseMaterial'])): ?>
                            <section class="panel panel-default padder">
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                  ...
                                  <tbody>
                                  	<?php foreach ($courseMaterialType['CourseMaterial'] as $courseMaterial): ?>
		<tr>
			<td class="actions">
