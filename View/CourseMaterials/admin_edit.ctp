...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo __('Admin Edit Course Material'); ?></h4>
    </div>
    <div class="modal-body">
		...
		echo $this->Form->input('course_material_type_id', array('class' => 'col-lg-2 control-label form-control'));
		echo $this->Form->input('course_material_permission_id', array('class' => 'col-lg-2 control-label form-control'));
		echo $this->Form->input('name', array('class' => 'col-lg-2 control-label form-control'));
		echo $this->Form->input('description', array('class' => 'col-lg-2 control-label form-control'));
