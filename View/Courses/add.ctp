<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header" style="text-align:center;">
      ...
      <h4 class="modal-title"><?php echo __('Add Course'); ?></h4>
    </div>
    <div class="modal-body">
		<?php
			...
			echo '<br>';
			echo $this->Form->input('pax', array('class' => 'form-control', 'type' => 'textbox', 'value' => '5'));
			echo '<br>';
			echo $this->Form->input('cost_pax', array('class' => 'form-control', 'type' => 'textbox', 'label' => 'Cost Per Pax (RM)', 'value' => '0.00'));
			echo '<br>';
			echo $this->Form->input('total_cost', array('class' => 'form-control', 'type' => 'textbox', 'label' => 'Total Cost (RM)', 'value' => '0.00'));
			echo '<br>';
			...
			echo '<br>';
			echo $this->Form->input('cycleTime', array('class' => 'form-control'));
			echo '<br>';
		?>
	 	<div class="row">
	 		<div class="col-lg-3">
