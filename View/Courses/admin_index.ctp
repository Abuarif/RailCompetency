          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><?php echo __('Course'); ?> List</li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Course'); ?> List</h3>
          </div>
...
<?php echo $this->Form->button('Go!', array('class' => 'btn btn-sm btn-default bg-success'));?>
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="col-md-2 text-center sorting"><?php echo __('Actions'); ?></th>
                                                        					                                  						<th>
            							 <?php echo $this->Paginator->sort('training_provider_id'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('module_id'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('service_id'); ?>            						</th>
                                    					                                  						<th>
            							 ...
            							 <?php echo $this->Paginator->sort('duration'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('isRefresher'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('cycleTime'); ?>            						</th>
                                    					                                  						<th>
	...
	<tr>
		<td class="actions">
      <?php echo $this->Form->postLink($this->Form->button('<i class="fa fa-trash-o"></i>', array('class'=>'btn btn-xs btn-danger', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Remove')), array('action' => 'delete', $course['Course']['id']), array('escape' => false, 'confirm' => 'Are you sure to delete this entry?')); ?>
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-calendar"></i>', array('class'=>'btn btn-xs btn-info', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Calendar')), array('action' => 'calendar', $course['Course']['id']), array('escape' => false)); ?>
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-desktop"></i>', array('class'=>'btn btn-xs btn-success', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'View Details')), array('action' => 'view', $course['Course']['id']), array('escape' => false)); ?>
		...
		<td><?php echo h($course['Course']['files']); ?>&nbsp;</td>
		<td><?php echo h($course['Course']['details']); ?>&nbsp;</td>
		<td><?php echo h($course['Course']['duration']); ?>&nbsp;</td>
		<td><?php echo h($course['Course']['isRefresher']); ?>&nbsp;</td>
		<td><?php echo h($course['Course']['cycleTime']); ?>&nbsp;</td>
