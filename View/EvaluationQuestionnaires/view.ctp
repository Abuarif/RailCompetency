          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Evaluation Questionnaire'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Evaluation Questionnaire'); ?>'s Details</h3>
          </div>
		...
		<p>
			<?php echo h($evaluationQuestionnaire['EvaluationQuestionnaire']['id']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Name'); ?></small>
		<p>
			<?php echo h($evaluationQuestionnaire['EvaluationQuestionnaire']['name']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Active'); ?></small>
		<p>
			<?php echo h($evaluationQuestionnaire['EvaluationQuestionnaire']['active']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Updated'); ?></small>
		<p>
			<?php echo h($evaluationQuestionnaire['EvaluationQuestionnaire']['updated']); ?>
			&nbsp;
		</p>
                        </section>
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Evaluation Questionnaire'), array('action' => 'edit', $evaluationQuestionnaire['EvaluationQuestionnaire']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Evaluation Questionnaire'), array('action' => 'delete', $evaluationQuestionnaire['EvaluationQuestionnaire']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $evaluationQuestionnaire['EvaluationQuestionnaire']['id'])); ?>  <?php echo $this->Html->link(__('List Evaluation Questionnaires'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Evaluation Questionnaire'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
                          ...
                          <div class="list-group bg-white">
                          <?php echo $this->Html->link(__('List Evaluation Details'), array('controller' => 'evaluation_details', 'action' => 'index'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp; <?php echo $this->Html->link(__('New Evaluation Detail'), array('controller' => 'evaluation_details', 'action' => 'add'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp;                           </div>
                        </section>
                      </div>
                      <!-- end portlet -->
                    </section>
                      ...
                      <div class="tab-content">
                        ...
                        <!-- start hasOne -->
                          ...
                          <!-- start hasMany -->
                            ...
                            <?php if (!empty($evaluationQuestionnaire['EvaluationDetail'])): ?>
                            <section class="panel panel-default padder">
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                  ...
                                  <tbody>
                                  	<?php foreach ($evaluationQuestionnaire['EvaluationDetail'] as $evaluationDetail): ?>
		<tr>
			<td class="actions">
