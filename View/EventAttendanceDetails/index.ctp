          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><?php echo __('Event Attendance Detail'); ?> List</li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Event Attendance Detail'); ?> List</h3>
          </div>
...
<?php echo $this->Form->button('Go!', array('class' => 'btn btn-sm btn-default bg-success'));?>
                ...
                <div class="table-responsive">
                  <table class="table table-striped b-t b-light">
                      ...
                      <tr>
                        ...
                        <th class="col-md-2 text-center sorting"><?php echo __('Actions'); ?></th>
            							 ...
            							 <?php echo $this->Paginator->sort('event_id'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('event_attendance_id'); ?>            						</th>
                                    					                                  						<th>
                           <?php echo $this->Paginator->sort('staff_id'); ?>                        </th>
                           <th>
                           <?php echo $this->Paginator->sort('day'); ?>                        </th>
                                    					                                  						<th>
                    ...
                    <tbody>
                      ...
                      <?php foreach ($eventAttendanceDetails as $eventAttendanceDetail): ?>
	<tr>
		<td class="actions">
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-calendar"></i>', array('class'=>'btn btn-xs btn-danger', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Calendar')), array('action' => 'calendar', $eventAttendanceDetail['EventAttendanceDetail']['id']), array('escape' => false)); ?>
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-desktop"></i>', array('class'=>'btn btn-xs btn-success', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'View Details')), array('action' => 'view', $eventAttendanceDetail['EventAttendanceDetail']['id']), array('escape' => false)); ?>
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-pencil"></i>', array('class'=>'btn btn-xs btn-warning', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Modify Details')), array('action' => 'edit', $eventAttendanceDetail['EventAttendanceDetail']['id']), array('data-toggle'=>'ajaxModal', 'escape' => false)); ?>
		</td>
		<td>
    ...
    <td>
      <?php echo $eventAttendanceDetail['EventAttendanceDetail']['day']; ?>
    </td>
					<?php if ($eventAttendanceDetail['EventAttendanceDetail']['active'] == 1) { ?>
