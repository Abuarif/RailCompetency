            ...
            <h3 class="m-b-none"><?php echo __('Event Attendance'); ?> List</h3>
              ...
              <section class="panel panel-default">
                <div class="row wrapper">
                  ...
                  <div class="col-sm-3">
                      <?php echo $this->Form->create('EventAttendance', array('class' => 'bs-example form-horizontal', 'inputDefaults' => array('label' => false, 'div' => false))); ?>
...
<?php echo $this->Form->button('Go!', array('class' => 'btn btn-sm btn-default bg-success'));?>
                      ...
                      <tr>
                        ...
                        <th class="col-md-2 text-center sorting"><?php echo __('Actions'); ?></th>
            							 ...
            							 <?php echo $this->Paginator->sort('signed_by'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('isEnrolled'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('isCompleted'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('notes'); ?>            						</th>
                                    					                                  						<th>
	...
	<tr>
		<td class="actions">
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-calendar"></i>', array('class'=>'btn btn-xs btn-danger', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Calendar')), array('action' => 'calendar', $eventAttendance['EventAttendance']['id']), array('escape' => false)); ?>
		...
		<td><?php echo h($eventAttendance['EventAttendance']['signed_by']); ?>&nbsp;</td>
		<td><?php echo h($eventAttendance['EventAttendance']['isEnrolled']); ?>&nbsp;</td>
		<td><?php echo h($eventAttendance['EventAttendance']['isCompleted']); ?>&nbsp;</td>
