...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">Course Attendance Checklist</h4>
    </div>
            ...
            <div class="table-responsive">
              <table class="table table-striped b-t b-light" style="overflow-x:auto;overflow-y: hidden">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <?php echo $this->Form->checkbox('EventAttendance.'.$iterate.'.is_completed', array('class' => 'input-sm form-control', 'label' => false,'data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Choose this staff!')); ?>
                      <?php echo $this->Form->hidden('EventAttendance.'.$iterate.'.id', array('class' => 'col-lg-2 control-label form-control', 'value' => $eventAttendance['EventAttendance']['id'], 'label' => false)); ?>
                    </td>
                    <td>
