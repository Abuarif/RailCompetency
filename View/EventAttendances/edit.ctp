...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo __('Edit Event Attendance'); ?></h4>
    </div>
    <div class="modal-body">
		...
		// echo $this->Form->input('is_enrolled', array('class' => 'col-lg-2 control-label form-control'));
		echo $this->Form->input('is_completed', array('label' => 'has completed training course.'));
		echo $this->Form->input('notes', array('class' => 'form-control', 'label' => '<br/><br/>Observation notes'));
