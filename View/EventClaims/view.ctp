          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Event Claim'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Event Claim'); ?>'s Details</h3>
          </div>
			...
			&nbsp;
                        ...
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Event Claim'), array('action' => 'edit', $eventClaim['EventClaim']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Event Claim'), array('action' => 'delete', $eventClaim['EventClaim']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $eventClaim['EventClaim']['id'])); ?>  <?php echo $this->Html->link(__('List Event Claims'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Event Claim'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
