...
<?php echo $this->Form->button('Go!', array('class' => 'btn btn-sm btn-default bg-success'));?>
                      ...
                      <tr>
                        ...
                        <th class="col-md-2 text-center sorting"><?php echo __('Actions'); ?></th>
            							 ...
            							 <?php echo $this->Paginator->sort('course_id'); ?>            						</th>
                                    					                                  						<th>
            							 <?php echo $this->Paginator->sort('trainer_id'); ?>            						</th>
                                    					                                  						<th>
	...
	<tr>
		...
		<td>
      <?php 
      // get trainer name from staffs
        $myStaff = $this->requestAction(
          array('controller' => 'staffs', 
            'action' => 'info', $eventTrainer['Trainer']['staff_id']));
        // print_r($myStaff);
      ?>
			<?php echo $this->Html->link($myStaff[$eventTrainer['Trainer']['staff_id']], array('controller' => 'trainers', 'action' => 'view', $eventTrainer['Trainer']['id'])); ?>
		</td>
