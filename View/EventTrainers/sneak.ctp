          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();">Sneak Preview: <?php echo __('Event Trainer'); ?>'s Details </a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none">Sneak Preview: <?php echo __('Event Trainer'); ?>'s Details </h3>
          </div>
		...
		<p>
			<?php echo h($eventTrainer['EventTrainer']['created']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Modified'); ?></small>
		<p>
			<?php echo h($eventTrainer['EventTrainer']['modified']); ?>
			&nbsp;
		</p>
                          <div class="line"></div>
                        </section>
