...
<div class="modal-dialog">
  <div class="modal-content">
  	<?php echo $this->Form->create('EventType', array('type' => 'file', 'class' => 'bs-example form-horizontal')); ?>
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal">&times;</button>
      <h4 class="modal-title"><?php echo __('Admin Edit Event Type'); ?></h4>
    </div>
    <div class="modal-body">
		...
		echo $this->Form->input('color', array('class' => 'col-lg-2 control-label form-control'));
