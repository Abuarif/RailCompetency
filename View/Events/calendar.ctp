          ...
          <div class="padder">
            ...
            <div>
              ...
              <div class="input-group">
                <?php echo $this->Form->input('service_id', array('options' => $services, 'class' => 'form-control input-s-sm inline v-middle')); ?>
                <?php
                  echo $this->Form->input('queryString', array('class' => 'input-sm form-control', 'placeholder' => 'Search Course Code')); ?>
            ...
            <div id="myEvents" class="pillbox clearfix m-b no-border no-padder">
              <ul>
                ...
                ?>
                    <li class="label bg-dark"><?php echo $value; ?></li>
                <?php
                  }
                }else{
                ?>
                  <input type="text" placeholder="Add course code">
                <?php } ?>
              </ul>
            </div>
            <div class="line"></div>
