                ...
                <header class="panel-heading bg-light clearfix">
                  <div class="row wrapper">
                    <div class="col-sm-6 m-b-xs btn-group">
                      <?php echo $this->Form->create('Event', array('action' => 'calendar_all', 'class' => 'bs-example form-horizontal', 'inputDefaults' => array('label' => false, 'div' => false))); ?>
...
<?php
  echo $this->Html->script(array(
      ...
      '../theme/LamanPuteri/js/fullcalendar/event_all.js',
