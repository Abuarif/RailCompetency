...
<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
  ...
  <li class="active">HRDF Claims</li>
</ul>
<!-- <div class="m-b-md">
                ...
                <header class="panel-heading bg-light clearfix">
                  <div class="row wrapper">
                    <div class="col-sm-6 m-b-xs btn-group">
                      <?php echo $this->Form->create('Event', array('action' => 'hrdf_claims', 'class' => 'bs-example form-horizontal', 'inputDefaults' => array('label' => false, 'div' => false))); ?>
...
<input type='hidden' name='server' id='server' value='https://rcms.prasarana.com.my<?php echo $this->webroot; ?>'>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-info"><a id="enrollUrl"><span style="color:white;"><i class="fa fa-dollars"></i>&nbsp;&nbsp;Manage Claim</span></a></button>
...
<?php
  echo $this->Html->script(array(
      ...
      '../theme/LamanPuteri/js/fullcalendar/event_hrdf.js',
