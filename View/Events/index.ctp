...
<section class="panel panel-default">
  <div class="row wrapper">
    <div class="col-lg-4 m-b-xs pull-left">
      <div class="btn-group">
        <?php echo $this->Html->link('<i class="fa fa-refresh"></i>&nbsp;&nbsp;Refresh', array('action' => 'index'), array('class' => 'btn btn-default btn-sm', 'escape' => false)); ?>
      </div>
    ...
    <div class="col-lg-4 m-b-xs">
      <?php echo $this->Form->create('Event', array('action' => 'index', 'class' => 'bs-example form-horizontal', 'inputDefaults' => array('label' => false, 'div' => false))); ?>
