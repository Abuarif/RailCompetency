...
<table style="border:none;text-align:left;width:100%;" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td style="width:50%;" colspan="3" rowspan="1">
            ...
            <?php	
				echo $this->Html->image('http://'.$_SERVER['SERVER_NAME'].Router::url('/')."theme/LamanPuteri/images/prasaranaheader.png", array('height'=> '150px', 'width'=>'380px'));
			?>
        </td>
    </tr>
</table>
<table style="border:none;text-align:left;width:100%;" cellpadding="0" cellspacing="0">
    <tr>
        <td style="height:30px;" colspan="4">
            Our Ref. :
            RAD/ITM/(<?php echo $event['EventMemo'][0]['ref_number']; ?>)<?php echo $this->Time->format($event['EventMemo'][0]['modified'], '%Y'); ?>-<?php echo $event['Course']['code']; ?>
        </td>
    </tr>
    <tr>
...
<table style="none;text-align:left;width:100%;padding-top:15px;" cellpadding="0" cellspacing="0">
    <tr>
        <td style="height:40px;">
            <div style="text-align:justify;line-height:25px;">
                With reference to the Appendix 1, all participants are expected to be ready in class 10 minutes before
                course commencement. As such, your punctuality is highly appreciated.
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td style="height:70px;">
            <div style="text-align:justify;line-height:25px;">
                Kindly be reminded that you are also required to adhere to all safety aspects and precaution during the
                course.
            </div>
        </td>
    </tr>
