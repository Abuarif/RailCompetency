		...
		<table style="border:none;text-align:left;width:100%;" cellpadding="0" cellspacing="0">
		    <tr>
		    	<td style="height:30px;" colspan="4">
		    		Our Ref. : RAD/ITM/(<?php echo $event['EventMemo'][0]['ref_number']; ?>)<?php echo $this->Time->format($event['EventMemo'][0]['modified'], '%Y'); ?>-<?php echo $event['Course']['code']; ?>
		    	</td>
		    </tr>
		    <tr>
		    	<td style="height:30px;" colspan="4">
		    ...
		    <tr>
		    	<td style="height:30px;font-weight:bold;" colspan="4">
