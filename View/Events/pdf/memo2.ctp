		...
		<table style="border:none;text-align:left;width:100%;" cellpadding="0" cellspacing="0">
		    <tr>
		    	...
		    	<td style="width:50%;" colspan="3" rowspan="1">
		    		<img src="<?php echo $this->webroot; ?>theme/lamanputeri/images/rapidrailheader.png" height="120px" width="319px">
		    	</td>
		    </tr>
		</table>
		<table style="border:none;text-align:left;width:100%;" cellpadding="0" cellspacing="0">
		...
		<table style="none;text-align:left;width:100%;" cellpadding="0" cellspacing="0">
			<tr>
				<td style="text-align:center;">
					<img src="<?php echo $this->webroot; ?>theme/lamanputeri/images/logo_collections.png" height="52px" width="614px;">
				</td>
			</tr>
		</table>
	</body>
