          ...
          <section class="panel panel-default">
            <header class="panel-heading bg-light clearfix">
              <div class="row wrapper">
                ...
                <div class="col-sm-4 m-b-xs">
                  <?php echo $this->Form->create('Event', array('action' => 'upcoming', 'class' => 'bs-example form-horizontal', 'inputDefaults' => array('label' => false, 'div' => false))); ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <?php if ($this->Session->read('Auth.User.role_id') != 8 ) { ?>
          <button class="btn btn-info"><a id="enrollUrl"><span style="color:white;"><i class="fa fa-users"></i>&nbsp;&nbsp;Manage Participant</span></a></button>
        <?php } else { ?>
          <button class="btn btn-info"><a id="attendanceUrl"><span style="color:white;"><i class="fa fa-users"></i>&nbsp;&nbsp;Manage Attendance</span></a></button>
        <?php } ?>
      </div>
    </div>
  </div>
