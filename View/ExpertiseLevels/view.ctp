          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Expertise Level'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Expertise Level'); ?>'s Details</h3>
          </div>
		...
		<p>
			<?php echo h($expertiseLevel['ExpertiseLevel']['id']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Name'); ?></small>
		<p>
			<?php echo h($expertiseLevel['ExpertiseLevel']['name']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Status'); ?></small>
		<p>
			<?php echo h($expertiseLevel['ExpertiseLevel']['status']); ?>
			&nbsp;
		</p>
                        </section>
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Expertise Level'), array('action' => 'edit', $expertiseLevel['ExpertiseLevel']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Expertise Level'), array('action' => 'delete', $expertiseLevel['ExpertiseLevel']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $expertiseLevel['ExpertiseLevel']['id'])); ?>  <?php echo $this->Html->link(__('List Expertise Levels'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Expertise Level'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
                          ...
                          <div class="list-group bg-white">
                          <?php echo $this->Html->link(__('List Trainers'), array('controller' => 'trainers', 'action' => 'index'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp; <?php echo $this->Html->link(__('New Trainer'), array('controller' => 'trainers', 'action' => 'add'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp;                           </div>
                        </section>
                      </div>
                      <!-- end portlet -->
                    </section>
                      ...
                      <div class="tab-content">
                        ...
                        <!-- start hasOne -->
                          ...
                          <!-- start hasMany -->
                            ...
                            <?php if (!empty($expertiseLevel['Trainer'])): ?>
                            <section class="panel panel-default padder">
                              <div class="row wrapper">
                                <div class="col-sm-5 m-b-xs">
                                    			<?php echo $this->Html->link(' Create', array('controller' => 'trainers', 'action' => 'add', '?' => array('returnURL' => $this->Html->url( null, true ))), array('class' => 'btn btn-default bg-success fa fa-plus', 'data-toggle'=>'ajaxModal', 'style'=>'color:#000;', 'escape' => false)); ?>
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                    ...
                                    <tr>
                                      <th class="actions"><?php echo __('Actions'); ?></th>
                                        		...
                                        		<?php echo __('Course Id'); ?>
                                                                                                                                                      ...
                                                                                                                                                      <th>
                                        		<?php echo __('Expertise Level Id'); ?>
                                      </th>
                                                                                                                                                      <th>
                                  ...
                                  <tfoot>
                                    <tr>
                                      <th class="actions"><?php echo __('Actions'); ?></th>
                                        		...
                                        		<th><?php echo __('Expertise Level Id'); ?></th>
                                  ...
                                  <tbody>
                                  	<?php foreach ($expertiseLevel['Trainer'] as $trainer): ?>
		<tr>
			<td class="actions">
			...
			<td><?php echo $trainer['expertise_level_id']; ?></td>
