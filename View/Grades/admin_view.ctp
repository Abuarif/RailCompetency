          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Grade'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Grade'); ?>'s Details</h3>
          </div>
		...
		<small class="text-uc text-xs text-muted"><?php echo __('Lower Marks'); ?></small>
		<p>
			<?php echo h($grade['Grade']['lower_marks']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Upper Marks'); ?></small>
		<p>
			<?php echo h($grade['Grade']['upper_marks']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Active'); ?></small>
		<p>
			<?php echo h($grade['Grade']['active']); ?>
			&nbsp;
		</p>
                        </section>
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Grade'), array('action' => 'edit', $grade['Grade']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Grade'), array('action' => 'delete', $grade['Grade']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $grade['Grade']['id'])); ?>  <?php echo $this->Html->link(__('List Grades'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Grade'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
                            ...
                            <section class="panel panel-default padder">
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                  ...
                                  <tbody>
                                  	<?php foreach ($grade['Evaluation'] as $evaluation): ?>
		<tr>
			<td class="actions">
