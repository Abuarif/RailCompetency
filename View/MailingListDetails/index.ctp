          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><?php echo __('Mailing List Detail'); ?> List</li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Mailing List Detail'); ?> List</h3>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table table-striped b-t b-light">
                    <thead>
                      <tr>
                        ...
                        <th class="col-md-2 text-center sorting"><?php echo __('Actions'); ?></th>
                                                        					                                  						<th>
            							 <?php echo $this->Paginator->sort('mailing_list_id'); ?>            						</th>
                                    					                                  						<th>
                    ...
                    <tbody>
                      ...
                      <?php foreach ($mailingListDetails as $mailingListDetail): ?>
	<tr>
		<td class="actions">
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-desktop"></i>', array('class'=>'btn btn-xs btn-success', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'View Details')), array('action' => 'view', $mailingListDetail['MailingListDetail']['id']), array('escape' => false)); ?>
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-pencil"></i>', array('class'=>'btn btn-xs btn-warning', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Modify Details')), array('action' => 'edit', $mailingListDetail['MailingListDetail']['id']), array('data-toggle'=>'ajaxModal', 'escape' => false)); ?>
		</td>
		<td>
		...
		<td>
			<?php echo $this->Html->link($mailingListDetail['Staff']['name'], array('controller' => 'staffs', 'action' => 'view', $mailingListDetail['Staff']['id'])); ?>
					...
					<?php if ($mailingListDetail['MailingListDetail']['active'] == 1) { ?>
