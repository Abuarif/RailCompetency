          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><?php echo __('Mailing List'); ?></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Mailing List'); ?></h3>
          </div>
...
<?php echo $this->Form->button('Go!', array('class' => 'btn btn-sm btn-default bg-success'));?>
	...
	<tr>
		<td class="actions">
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-gears"></i>', array('class'=>'btn btn-xs btn-success', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Manage Mailing List')), array('controller' => 'mailing_list_details', 'action' => 'manage', $mailingList['MailingList']['id']), array('escape' => false)); ?>
