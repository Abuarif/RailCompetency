            ...
            <div class="col-sm-12 portlet">
              <section class="panel panel-default portlet-item">
                ...
                <div class="panel-body text-center">
                  <?php 
                    $count = 0;
                    if (!empty($mailing_list['MailingListDetail'])) 
                      $count = count($mailing_list['MailingListDetail']);
                  ?>
          ...
          <div class="table-responsive">
            <table class="table table-striped b-t b-light" style="overflow-x:auto;overflow-y: hidden">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <?php echo $this->Form->checkbox('MailingListDetail.'.$iterate.'.is_enrolled', array('class' => 'input-sm form-control', 'label' => false,'data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Choose this staff!')); ?>
                    ...
                    <?php echo $this->Form->hidden('MailingListDetail.'.$iterate.'.event_id', array('class' => 'col-lg-2 control-label form-control', 'value' => $event_id, 'label' => false)); ?>
                    <?php echo $this->Form->hidden('MailingListDetail.'.$iterate.'.signed_by', array('class' => 'col-lg-2 control-label form-control', 'value' => $this->Session->read('Auth.User.id'), 'label' => false)); ?>
                    <?php echo $this->Form->hidden('MailingListDetail.'.$iterate.'.active', array('class' => 'col-lg-2 control-label form-control', 'value' => false, 'label' => false)); ?>
                  </td>
                  <td>
      ...
      <div class="tab-pane padder <?php echo ($myActive=='Participants'?'active':''); ?>" id="participants">
        ...
        <section class="panel panel-default ">
            ...
            <table class="table table-striped b-t b-light">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo $eventAttendance['Staff']['email']; ?>
                    </td>
                  </tr>
                  <?php 
                    $participant++;
          ...
          <footer class="panel-footer">
            <div class="row">
              <div class="col-sm-4 text-left hidden-xs">
                <?php $doAction = array('0' => 'Bulk Action', '1' => 'Delete selected', '2' => 'Confirm Participation', '3' => 'Cancel Participation'); ?>
