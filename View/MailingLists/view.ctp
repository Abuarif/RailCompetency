          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Mailing List'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Mailing List'); ?>'s Details</h3>
          </div>
		...
		<p>
			<?php echo h($mailingList['MailingList']['id']); ?>
			&nbsp;
		</p>
		...
		<p>
			<?php echo h($mailingList['MailingList']['active']); ?>
			&nbsp;
		</p>
                        </section>
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Mailing List'), array('action' => 'edit', $mailingList['MailingList']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Mailing List'), array('action' => 'delete', $mailingList['MailingList']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $mailingList['MailingList']['id'])); ?>  <?php echo $this->Html->link(__('List Mailing Lists'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Mailing List'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
                          ...
                          <div class="list-group bg-white">
                          <?php echo $this->Html->link(__('List Mailing List Details'), array('controller' => 'mailing_list_details', 'action' => 'index'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp; <?php echo $this->Html->link(__('New Mailing List Detail'), array('controller' => 'mailing_list_details', 'action' => 'add'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp;                           </div>
                        </section>
                      </div>
                      <!-- end portlet -->
                    </section>
                    ...
                    <header class="header bg-light bg-gradient" style="height:auto">
                      <div>
                        ...
                        <li class="active"><a href="#dashboard" data-toggle="tab">Dashboard</a></li>
                                                  <!-- end of hasOne -->
                          <!-- start hasMany -->
                                                      <li><a href="#MailingListDetails" data-toggle="tab">Mailing List Details</a></li>
                    ...
                    <article class="scrollable">
                      ...
                      <div class="tab-content">
                        ...
                        <!-- start hasOne -->
                                                  <!-- end hasOne -->
                          <!-- start hasMany -->
                                                  <div class="tab-pane padder" id="MailingListDetails">
                            <h3><?php echo __('Related Mailing List Details'); ?></h3>
                            

                            <?php if (!empty($mailingList['MailingListDetail'])): ?>
                            <section class="panel panel-default padder">
                              <div class="row wrapper">
                                <div class="col-sm-5 m-b-xs">
                                    			<?php echo $this->Html->link(' Create', array('controller' => 'mailing_list_details', 'action' => 'add', '?' => array('returnURL' => $this->Html->url( null, true ))), array('class' => 'btn btn-default bg-success fa fa-plus', 'data-toggle'=>'ajaxModal', 'style'=>'color:#000;', 'escape' => false)); ?>
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                  ...
                                  <tfoot>
                                    <tr>
                                      <th class="actions"><?php echo __('Actions'); ?></th>
                                        		...
                                        		<th><?php echo __('Mailing List Id'); ?></th>
                                  ...
                                  <tbody>
                                  	<?php foreach ($mailingList['MailingListDetail'] as $mailingListDetail): ?>
		<tr>
			<td class="actions">
				<?php echo $this->Html->link('', array('controller' => 'mailing_list_details', 'action' => 'sneak', $mailingListDetail['id']), array('class'=>'btn btn-xs btn-success fa fa-desktop', 'style'=>'color:#000;width:25px; height:25px; padding-top:5px','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'View Details', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>
				<?php echo $this->Html->link('', array('controller' => 'mailing_list_details', 'action' => 'edit', $mailingListDetail['id']), array('class'=>'btn btn-xs btn-warning fa fa-pencil', 'style'=>'color:#000;width:25px; height:25px; padding-top:5px','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Modify Details', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>
			</td>
			<td><?php echo $mailingListDetail['mailing_list_id']; ?></td>
			<td><?php echo $mailingListDetail['staff_id']; ?></td>
			<td><?php echo $mailingListDetail['active']; ?></td>
		</tr>
	<?php endforeach; ?>
                                    <tr>
                                    </tr>
