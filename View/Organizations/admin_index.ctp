          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><?php echo __('Organization'); ?> List</li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Organization'); ?> List</h3>
          </div>
              ...
              <section class="panel panel-default">
                <div class="row wrapper">
                  ...
                  <div class="col-sm-3">
                      <?php echo $this->Form->create('Organization', array('class' => 'bs-example form-horizontal', 'inputDefaults' => array('label' => false, 'div' => false))); ?>
...
<?php echo $this->Form->button('Go!', array('class' => 'btn btn-sm btn-default bg-success'));?>
	...
	<tr>
		<td class="actions">
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-desktop"></i>', array('class'=>'btn btn-xs btn-success', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'View Details')), array('action' => 'view', $organization['Organization']['id']), array('escape' => false)); ?>
			<?php echo $this->Html->link($this->Form->button('<i class="fa fa-pencil"></i>', array('class'=>'btn btn-xs btn-warning', 'style'=>'color:#000; width:25px; height:25px;','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Modify Details')), array('action' => 'edit', $organization['Organization']['id']), array('data-toggle'=>'ajaxModal', 'escape' => false)); ?>
		</td>
		<td>
		...
		<td><?php echo h($organization['Organization']['parent_code']); ?>&nbsp;</td>
		<td><?php echo h($organization['Organization']['org_code']); ?>&nbsp;</td>
		<td><?php echo h($organization['Organization']['name']); ?>&nbsp;</td>
		<td><?php echo h($organization['Organization']['details']); ?>&nbsp;</td>
		<td><?php echo h($organization['Organization']['lft']); ?>&nbsp;</td>
		<td><?php echo h($organization['Organization']['rght']); ?>&nbsp;</td>
					<?php if ($organization['Organization']['active'] == 1) { ?>
