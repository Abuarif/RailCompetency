          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><?php echo __('Program Course'); ?> Calendar</li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Program Course'); ?> Calendar</h3>
          </div>
          ...
          <section class="vbox">
            ...
            <aside class="aside-lg b-l">
              <div class="padder">
                <h5>Dragable <?php echo __('Program Course'); ?></h5>
                <div class="line"></div>
