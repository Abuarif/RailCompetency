          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();">Sneak Preview: <?php echo __('Program Course'); ?>'s Details </a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none">Sneak Preview: <?php echo __('Program Course'); ?>'s Details </h3>
          </div>
		...
		<p>
			<?php echo h($programCourse['ProgramCourse']['created']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Modified'); ?></small>
		<p>
			<?php echo h($programCourse['ProgramCourse']['modified']); ?>
			&nbsp;
		</p>
                          <div class="line"></div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Program Course'), array('action' => 'edit', $programCourse['ProgramCourse']['id']), array('class'=>'list-group-item')); ?> <?php echo $this->Form->postLink(__('Delete Program Course'), array('action' => 'delete', $programCourse['ProgramCourse']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $programCourse['ProgramCourse']['id'])); ?>  <?php echo $this->Html->link(__('List Program Courses'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Program Course'), array('action' => 'add'), array('class'=>'list-group-item')); ?>                          </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            <ul class="nav nav-pills pull-right">
