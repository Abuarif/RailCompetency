		...
		<p>
			<?php echo h($program['Program']['active']); ?>
			&nbsp;
		</p>
                        </section>
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Program'), array('action' => 'edit', $program['Program']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Program'), array('action' => 'delete', $program['Program']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $program['Program']['id'])); ?>  <?php echo $this->Html->link(__('List Programs'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Program'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
                          ...
                          <div class="list-group bg-white">
                          <?php echo $this->Html->link(__('List Program Courses'), array('controller' => 'program_courses', 'action' => 'index'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp; <?php echo $this->Html->link(__('New Program Course'), array('controller' => 'program_courses', 'action' => 'add'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp;                           </div>
                        </section>
                      </div>
                      <!-- end portlet -->
                    </section>
                    ...
                    <header class="header bg-light bg-gradient" style="height:auto">
                      <div>
                        ...
                        <li class="active"><a href="#dashboard" data-toggle="tab">Dashboard</a></li>
                                                  <!-- end of hasOne -->
                          <!-- start hasMany -->
                                                      <li><a href="#ProgramCourses" data-toggle="tab">Program Courses</a></li>
                    ...
                    <article class="scrollable">
                      ...
                      <div class="tab-content">
                        ...
                        <!-- start hasOne -->
                                                  <!-- end hasOne -->
                          <!-- start hasMany -->
                                                  <div class="tab-pane padder" id="ProgramCourses">
                            ...
                            <section class="panel panel-default padder">
                              <div class="row wrapper">
                                <div class="col-sm-5 m-b-xs">
                                    			<?php echo $this->Html->link(' Create', array('controller' => 'program_courses', 'action' => 'add' ), array('class' => 'btn btn-default bg-success fa fa-plus', 'data-toggle'=>'ajaxModal', 'style'=>'color:#000;', 'escape' => false)); ?>
		...
		<tr>
			<td class="actions">
				<?php echo $this->Html->link('', array('controller' => 'program_courses', 'action' => 'sneak', $programCourse['id']), array('class'=>'btn btn-xs btn-success fa fa-desktop', 'style'=>'color:#000;width:25px; height:25px; padding-top:5px','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'View Details', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>
			...
			<td><?php echo $programCourse['program_id']; ?></td>
			<td><?php echo $programCourse['course_id']; ?></td>
			<td><?php echo $programCourse['active']; ?></td>
		</tr>
	<?php endforeach; ?>
                                    <tr>
                                    </tr>
