          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Service'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Service'); ?>'s Details</h3>
          </div>
    ...
    <small class="text-uc text-xs text-muted"><?php echo __('Memo Header'); ?></small>
    <p>
      <?php echo h($service['Service']['memo_header']); ?>
      &nbsp;
    </p>
    <small class="text-uc text-xs text-muted"><?php echo __('Color'); ?></small>
    <p>
      <?php echo h($service['Service']['color']); ?>
      &nbsp;
    </p>
			...
			&nbsp;
                        ...
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Service'), array('action' => 'edit', $service['Service']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Service'), array('action' => 'delete', $service['Service']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $service['Service']['id'])); ?>  <?php echo $this->Html->link(__('List Services'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Service'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
                            ...
                            <section class="panel panel-default padder">
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                  ...
                                  <tbody>
                                  	<?php foreach ($service['Course'] as $course): ?>
		<tr>
			<td class="actions">
	...
	<?php endforeach; ?>
                            ...
                            <?php if (!empty($service['StaffAssignment'])): ?>
                            <section class="panel panel-default padder">
                              <div class="row wrapper">
                                <div class="col-sm-5 m-b-xs">
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                  ...
                                  <tbody>
                                  	<?php foreach ($service['StaffAssignment'] as $staffAssignment): ?>
		<tr>
			<td class="actions">
