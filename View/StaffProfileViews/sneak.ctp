          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();">Sneak Preview: <?php echo __('Staff Profile View'); ?>'s Details </a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none">Sneak Preview: <?php echo __('Staff Profile View'); ?>'s Details </h3>
          </div>
			...
			&nbsp;
                        ...
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Staff Profile View'), array('action' => 'edit', $staffProfileView['StaffProfileView']['id']), array('class'=>'list-group-item')); ?> <?php echo $this->Form->postLink(__('Delete Staff Profile View'), array('action' => 'delete', $staffProfileView['StaffProfileView']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $staffProfileView['StaffProfileView']['id'])); ?>  <?php echo $this->Html->link(__('List Staff Profile Views'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Staff Profile View'), array('action' => 'add'), array('class'=>'list-group-item')); ?>                          </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            <ul class="nav nav-pills pull-right">
