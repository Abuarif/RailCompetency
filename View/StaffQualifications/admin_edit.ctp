...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo __('Admin Edit Staff Qualification'); ?></h4>
    </div>
    <div class="modal-body">
		...
		echo $this->Form->input('certificate_name', array('class' => 'col-lg-2 control-label form-control'));
		echo $this->Form->input('completed_on', array('class' => 'col-lg-2 datepicker-input control-label form-control', 'value' => date("d-m-Y"), 'data-date-format' => 'dd-mm-yyyy', 'type' => 'text', 'style' => 'z-index: 100000!important;'));
