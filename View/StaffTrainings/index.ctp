<div class="staffTrainings index">
	<h2><?php echo __('Staff Trainings'); ?></h2>
	...
	<tbody>
	<?php foreach ($staffTrainings as $staffTraining): ?>
	<tr>
		<td><?php echo h($staffTraining['StaffTraining']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($staffTraining['StaffTraining']['created']); ?>&nbsp;</td>
		<td><?php echo h($staffTraining['StaffTraining']['updated']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $staffTraining['StaffTraining']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $staffTraining['StaffTraining']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $staffTraining['StaffTraining']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $staffTraining['StaffTraining']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
