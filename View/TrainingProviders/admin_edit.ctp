...
<div class="modal-dialog">
  <div class="modal-content">
  	<?php echo $this->Form->create('TrainingProvider', array('type' => 'file', 'class' => 'bs-example form-horizontal')); ?>
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal">&times;</button>
      <h4 class="modal-title"><?php echo __('Admin Edit Training Provider'); ?></h4>
    </div>
