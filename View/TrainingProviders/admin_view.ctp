          <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li class="active"><a href="#" onClick="location.reload();"><?php echo __('Training Provider'); ?>'s Details</a></li>
          </ul>
          <div class="m-b-md">
            <h3 class="m-b-none"><?php echo __('Training Provider'); ?>'s Details</h3>
          </div>
		...
		<p>
			<?php echo h($trainingProvider['TrainingProvider']['id']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Name'); ?></small>
		<p>
			<?php echo h($trainingProvider['TrainingProvider']['name']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Details'); ?></small>
		<p>
			<?php echo h($trainingProvider['TrainingProvider']['details']); ?>
			&nbsp;
		</p>
		<small class="text-uc text-xs text-muted"><?php echo __('Active'); ?></small>
		<p>
			<?php echo h($trainingProvider['TrainingProvider']['active']); ?>
			&nbsp;
		</p>
                        </section>
                        <section class="panel panel-info portlet-item">
                          ...
                          <div class="list-group bg-white">
                           <?php echo $this->Html->link(__('Edit Training Provider'), array('action' => 'edit', $trainingProvider['TrainingProvider']['id']), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal')); ?> <?php echo $this->Form->postLink(__('Delete Training Provider'), array('action' => 'delete', $trainingProvider['TrainingProvider']['id']), array('class'=>'list-group-item'), __('Are you sure you want to delete # %s?', $trainingProvider['TrainingProvider']['id'])); ?>  <?php echo $this->Html->link(__('List Training Providers'), array('action' => 'index'), array('class'=>'list-group-item')); ?> <?php echo $this->Html->link(__('New Training Provider'), array('action' => 'add'), array('class'=>'list-group-item', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>                              </div>
                        </section>
                        <section class="panel panel-info portlet-item">
                          <header class="panel-heading">
                            Associated links
                          ...
                          <div class="list-group bg-white">
                          <?php echo $this->Html->link(__('List Courses'), array('controller' => 'courses', 'action' => 'index'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp; <?php echo $this->Html->link(__('New Course'), array('controller' => 'courses', 'action' => 'add'), array('class' => 'list-group-item')); ?> &nbsp;&nbsp;                           </div>
                        </section>
                      </div>
                      <!-- end portlet -->
                    </section>
                    ...
                    <article class="scrollable">
                      ...
                      <div class="tab-content">
                        ...
                        <!-- start hasOne -->
                                                  <!-- end hasOne -->
                          <!-- start hasMany -->
                                                  <div class="tab-pane padder" id="Courses">
                            <h3><?php echo __('Related Courses'); ?></h3>
                            

                            <?php if (!empty($trainingProvider['Course'])): ?>
                            <section class="panel panel-default padder">
                              <div class="row wrapper">
                                <div class="col-sm-5 m-b-xs">
                                    			<?php echo $this->Html->link(' Create', array('controller' => 'courses', 'action' => 'add' ), array('class' => 'btn btn-default bg-success fa fa-plus', 'data-toggle'=>'ajaxModal', 'style'=>'color:#000;', 'escape' => false)); ?>
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped b-t b-light">
                                  <thead>
                                    <tr>
                                      <th class="actions"><?php echo __('Actions'); ?></th>
                                                                                                                                                                                              <th>
                                        		<?php echo __('Training Provider Id'); ?>
                                      </th>
                                                                                                                                                      <th>
                                        		<?php echo __('Module Id'); ?>
                                      </th>
                                                                                                                                                      <th>
                                        		...
                                        		<?php echo __('Duration'); ?>
                                                                                                                                                      ...
                                                                                                                                                      <th>
                                        		<?php echo __('IsRefresher'); ?>
                                      </th>
                                                                                                                                                      <th>
                                        		<?php echo __('CycleTime'); ?>
                                      </th>
                                                                                                                                                      <th>
                                        		<?php echo __('Active'); ?>
                                      </th>
                                  ...
                                  <tfoot>
                                    <tr>
                                      <th class="actions"><?php echo __('Actions'); ?></th>
                                        		...
                                        		<th><?php echo __('Training Provider Id'); ?></th>
                                        		...
                                        		<th><?php echo __('IsRefresher'); ?></th>
                                      
                                                                                                                                                      
                                        		<th><?php echo __('CycleTime'); ?></th>
                                  ...
                                  <tbody>
                                  	<?php foreach ($trainingProvider['Course'] as $course): ?>
		<tr>
			<td class="actions">
				<?php echo $this->Html->link('', array('controller' => 'courses', 'action' => 'sneak', $course['id']), array('class'=>'btn btn-xs btn-success fa fa-desktop', 'style'=>'color:#000;width:25px; height:25px; padding-top:5px','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'View Details', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>
				<?php echo $this->Html->link('', array('controller' => 'courses', 'action' => 'edit', $course['id']), array('class'=>'btn btn-xs btn-warning fa fa-pencil', 'style'=>'color:#000;width:25px; height:25px; padding-top:5px','data-toggle'=>'tooltip', 'data-placement'=>'right', 'title'=>'Modify Details', 'data-toggle'=>'ajaxModal', 'escape' => false)); ?>
			</td>
			<td><?php echo $course['training_provider_id']; ?></td>
			<td><?php echo $course['module_id']; ?></td>
			<td><?php echo $course['service_id']; ?></td>
			<td><?php echo $course['code']; ?></td>
			<td><?php echo $course['name']; ?></td>
			<td><?php echo $course['files']; ?></td>
			<td><?php echo $course['details']; ?></td>
			<td><?php echo $course['duration']; ?></td>
			<td><?php echo $course['isRefresher']; ?></td>
			<td><?php echo $course['cycleTime']; ?></td>
