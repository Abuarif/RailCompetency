...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo __('Download Staff Training Attendance'); ?></h4>
    </div>
    <div class="modal-body">
		<?php

		echo $this->Form->input('service_id', array('options' => $services, 'class' => 'form-control input-s-sm inline v-middle', 'empty' => '(choose one)'));
